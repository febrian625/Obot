...
let errorImg = 'https://a.top4top.io/p_21369rqp60.jpg'
      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI FebroBots`
			ind = {
			...
			/////
let ikyads = await getBuffer(`https://a.top4top.io/p_21369rqp60.jpg`)
fakelink = (tekslink) => { 
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `62895322309227`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
            ...
            case 'spamsms':{
                ...
                try {
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam1?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam2?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam3?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam4?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam5?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam6?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam7?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    await fetchJson(`https://api.lolhuman.xyz/api/sms/spam8?apikey=b750179afd268c5fcee71d48&nomor=${args[1]}`)
                    reply("Success")
               } catch (err) {
                            sendMess(ownerNumber, `${command} Error:` + err)
                            reply(mess.error.api)
...
case 'lock':
 ikymemek = {
  "key": {
    "fromMe": false,
    participant: `62895322309227@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
🐟 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created FebroBots☕`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @feb.r.ian`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
...
case 'chiisaihentai':
                ...
                reply (mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=b750179afd268c5fcee71d48`)
              ...
              ikyy.relayWAMessage(prep)
                ...
                case 'nsfw_avatar':
                reply (mess.wait)
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=b750179afd268c5fcee71d48`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
...
break
                ...
                reply (mess.wait)
                    ...
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=b750179afd268c5fcee71d48&text=${ini_txt}`)
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                 buff = await getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=b750179afd268c5fcee71d48&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                  buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=b750179afd268c5fcee71d48&text=${ini_txt}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕T', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                buff = await getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=b750179afd268c5fcee71d48&text1=${txt1}&text2=${txt2}`)
                          buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
              ...
              ikyy.relayWAMessage(prep)
                ...
                reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
             buff = await getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=b750179afd268c5fcee71d48&text=${ini_txt}`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @feb.r.ian`,buttons,headerType:4}
...
case 'sandw':
reply (mess.wait)
                    if (args.length == 0) return reply(`Example: ${prefix + command} Febrian`)
                    ini_txt = args.join(" ")
...
case "mode":
        ...
        break;
	      case 'self':
              ...
              break
                case 'quotes':
                    quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotes?apikey=b750179afd268c5fcee71d48`)
                    ...
                    break
                case 'quotesanime':
                    quotes = await fetchJson(`https://api.lolhuman.xyz/api/random/quotesnime?apikey=b750179afd268c5fcee71d48`)
                    quotes = quotes.result
                    quote = quotes.quote
                    ...
                    break
                case 'quotesdilan':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=b750179afd268c5fcee71d48`)
                     reply(get_result.result)

                   break
                    break
                case 'quotesimage':
                    buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=b750179afd268c5fcee71d48`)
                    buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots', imageMessage: imageMsg,
              ...
              ikyy.relayWAMessage(prep)
                ...
                case 'pantun':
                case 'bucin':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=b750179afd268c5fcee71d48`)
        ...
        break;
                    break
                case 'randomnama':
                    anu = await fetchJson(`https://api.lolhuman.xyz/api/random/nama?apikey=b750179afd268c5fcee71d48`)
                    kyyi = anu.result
       ...
       // Movie & Story
                case 'lk21':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=b750179afd268c5fcee71d48&query=${query}`)
                    ...
                    break
                case 'drakorongoing':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                ...
                case 'wattpad':
                    ...
                    ini_url = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=b750179afd268c5fcee71d48&url=${ini_url}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Rating : ${get_result.rating}\n`
                ...
                case 'wattpadsearch':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=b750179afd268c5fcee71d48&query=${query}`)
                    get_result = get_result.result
                    ...
                    break
                case 'cerpen':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
        ...
        break
                    break
                case 'ceritahoror':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Desc : ${get_result.desc}\n`
                    ini_txt += `Story :\n${get_result.story}\n`
...
`
 ...
 FebroBots☕︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
`
 ...
 FebroBots☕︎`, imageMessage: imageMsg,
   ...
   case 'command':
               list = []
               listmenu = [`groupmenu`,`photoxy`,`makermenu`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`gcfebrobots`,`sewabot`]
...
// Islami //
                case 'listsurah':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                    ini_txt = 'List Surah:\n'
                ...
                case 'alquran':
                    ...
                    urls = `https://api.lolhuman.xyz/api/quran/${args[0]}?apikey=b750179afd268c5fcee71d48`
                ...
                case 'alquranaudio':
                    ...
                    surah = args[0]
                    ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=b750179afd268c5fcee71d48`)
                    await ikyy.sendMessage(from, ini_buffer, audio, { quoted: freply, mimetype: Mimetype.mp4Audio })
                    break
                case 'asmaulhusna':
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                ...
                case 'kisahnabi':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
                ...
                case 'jadwalsholat':
                    ...
                    daerah = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=b750179afd268c5fcee71d48`)
                    get_result = get_result.result
...
break
           ...
           case 'liststicker':
            ...
            case 'done':
              if (!isGroup) return reply(mess.only.group)
              reply('Orderan Dari Buyer Ke Febrian Telah Berhasil\nTerimakasih Telah Order Di Febrian 😊\nJangan Lupa Order Kembali👋')
             break
			case 'getvideo':
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated FebroBots☕︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
       ...
       case 'family100':
              ...
              anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=b750179afd268c5fcee71d48`)
       ...
       case 'tebakanime':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
       ...
       case 'siapaaku':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
       ...
       case 'tebakkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.jawaban
       ...
       case 'tebaklirik':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
      ...
      case 'tebakjenaka':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
       ...
       case 'kimiakuis':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
       ...
       case 'tebakbendera':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.name
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
       ...
       case 'susunkata':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
       ...
       case 'asahotak':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
       ...
       case 'caklontong':
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=b750179afd268c5fcee71d48`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
...
*「 FebroBots☕︎ 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di FebroBots🐟*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              gopeynya = 'https://i.top4top.io/p_2136qolx90.jpg'
...
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `Premium`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'FebroBots☕︎ ', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
      break
case 'tod':
              gopeynya = 'https://k.top4top.io/p_2136h7fk40.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `
...
//------------------< Downloader/Search/Anime >-------------------
       ...
       case 'soundcloud':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=b750179afd268c5fcee71d48&url=${q}`)
...
ikyy.sendMessage(from,{url:'./'+kyyyy},audio,{mimetype:'audio/mpeg'})
       ...
       case 'tiktoknowm':
              ...
              data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=b750179afd268c5fcee71d48&url=${q}`)
  ...
  case 'xnxxsearch':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/xnxxsearch?apikey=b750179afd268c5fcee71d48&query=${query}`)
                    get_result = get_result.result
                    ini_txt = ""
                    for (var x of get_result) {
                        ini_txt += `Title : ${x.title}\n`
                ...
                case 'xnxx':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/xnxx?apikey=b750179afd268c5fcee71d48&url=${query}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Duration : ${get_result.duration}\n`
      ...
      case 'tiktokaudio':
             ...
             ini_link = args[0]
             get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=b750179afd268c5fcee71d48&url=${ini_link}`)
      ...
      case 'ssweb':
       ...
       case 'nhentaipdf':
             ...
             try {
             henid = args[0]
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=b750179afd268c5fcee71d48`)
             get_result = get_result.result
...
🐋 Character : ${get_info.characters.join(", ")}\n`
             ...
             reply(mess.wait)
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=b750179afd268c5fcee71d48`)
       ...
       case 'manga':
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=b750179afd268c5fcee71d48&query=${query}`)
              get_result = get_result.result
      ...
      case 'anime':
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=b750179afd268c5fcee71d48&query=${query}`)
             get_result = get_result.result
             ini_txt = `Id : ${get_result.id}\n`
             ini_txt += `Id MAL : ${get_result.idMal}\n`
             ini_txt += `Title : ${get_result.title.romaji}\n`
      ...
      case 'kusonime':
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=b750179afd268c5fcee71d48&query=${query}`)
             get_result = get_result.result
             ini_txt = `Title : ${get_result.title}\n`
       ...
       case 'otakudesu':
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=b750179afd268c5fcee71d48&query=${query}`)
              get_result = get_result.result
              ini_txt = `Title : ${get_result.title}\n`
              ini_txt += `Japanese : ${get_result.japanese}\n`
       ...
       case 'nekopoi':
              ...
              ini_url = args[0]
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=b750179afd268c5fcee71d48&url=${ini_url}`)
              get_result = get_result.result
       ...
       case 'nekopoisearch':
              ...
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=b750179afd268c5fcee71d48&query=${query}`)
              get_result = get_result.result
              ini_txt = ""
              for (var x of get_result) {
              ini_txt += `\`\`\`🦈 Title : ${x.title}\`\`\`\n`
       ...
       case 'storyanime':
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=b750179afd268c5fcee71d48`)
...
break
          ...
          case 'lirik':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/lirik?apikey=b750179afd268c5fcee71d48&query=${query}`)
                    reply(get_result.result)
         ...
         case 'pinterest':
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                    query = args.join(" ")
                 reply (mess.wait)
                    ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=b750179afd268c5fcee71d48&query=${query}`)
...
//------------------< Stalk >-------------------
      ...
      case 'githubstalk':
              ...
              reply(mess.wait)
              username = args[0]
              ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=b750179afd268c5fcee71d48`)
...
`
      ...
      case 'igstalk':
             ...
             reply(mess.wait)
             username = args[0]
             ini_result = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${username}?apikey=b750179afd268c5fcee71d48`)
             ini_result = ini_result.result
...
`
      ...
      case 'tiktokstalk':
             ...
             reply(mess.wait)
             stalk_toktok = args[0]
             get_result = await fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${stalk_toktok}?apikey=b750179afd268c5fcee71d48`)
             get_result = get_result.result
...
//------------------< Sticker/Tools >-------------------
      ...
      case 'doge':
       ...
       case 'telestiker':
              ...
              reply(mess.wait)
              ini_url = await fetchJson(`https://api.lolhuman.xyz/api/telestick?apikey=b750179afd268c5fcee71d48&url=${args[0]}`)
       ...
       case 'emoji':
              ...
              ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=b750179afd268c5fcee71d48`)
...
break
       ...
       case 'triggered':
           ...
           teks = args.join(' ')
                ...
                let ane = await getBuffer(`https://api.lolhuman.xyz/api/attp?apikey=b750179afd268c5fcee71d48&text=${mek}`)
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 FebroBots Broadcast 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*「 FebroBots Broadcast 」*\n\n${body.slice(4)}`,
			"footerText": 'FebroBots ㌹',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://k.top4top.io/p_2136h7fk40.jpg'
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('62895322309227@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('62895322309227@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatfeb':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT FEB DONE')
              ikyy.sendMessage('62895322309227@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://instagram.com/feb.r.ian?utm_medium=copy_link`)
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
